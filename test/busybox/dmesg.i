...
# 1 "<command-line>" 2
# 1 "util-linux/dmesg.c"
# 20 "util-linux/dmesg.c"
# 1 "/usr/include/x86_64-linux-gnu/sys/klog.h" 1 3 4
# 21 "/usr/include/x86_64-linux-gnu/sys/klog.h" 3 4
...
# 22 "/usr/include/x86_64-linux-gnu/sys/klog.h" 2 3 4
...
extern int klogctl (int __type, char *__bufp, int __len) __attribute__ ((__nothrow__ , __leaf__));


# 21 "util-linux/dmesg.c" 2
# 1 "include/libbb.h" 1
# 13 "include/libbb.h"
...
# 22 "util-linux/dmesg.c" 2

int dmesg_main(int argc, char **argv) ;
int dmesg_main(int argc __attribute__ ((__unused__)), char **argv)
{
 int len, level;
 char *buf;
 unsigned opts;
 ...
 opt_complementary = "s+:n+";
 opts = getopt32(argv, "cs:n:", &len, &level);
 if (opts & OPT_n) {
  if (klogctl(8, ((void *)0), (long) level))
   bb_perror_msg_and_die("klogctl");
  return 0;
 }

 if (!(opts & OPT_s))
  len = klogctl(10, ((void *)0), 0);
 if (len < 16*1024)
  len = 16*1024;
 if (len > 16*1024*1024)
  len = 16*1024*1024;
